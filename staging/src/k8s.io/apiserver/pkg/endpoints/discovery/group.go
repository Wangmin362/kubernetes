...
// 暴露关于一个/apis/<group>的路由，使得用户可以查询一个group相关的信息，从定义中来看，APIGroupHandler似乎并没有返回关于资源
// 的信息，仅仅返回了组下的版本信息，具体版本信息的查询需要通过 APIVersionHandler 来获取
type APIGroupHandler struct {
	// 根据Group, Version协商出序列化、反序列化器
	serializer runtime.NegotiatedSerializer
	// 标识一个group下包含了哪些版本，具体的资源信息应该需到 APIVersionHandler 当中获取
