...
type Cache interface {
	...
	// 的节点上，并在Cache当中记录下来。猜测这样做的目的在于Pod如果真的绑定到了Node之上，是需要占用资源的。因此这里假定Pod已经被成功调度，
	// 同时，在后续Pod需要调度的时候把当前AssumedPod所占用的资源剔除掉。
	// 3、TODO 如果这个AssumedPod在BindingCycle阶段出现错误怎么办？
